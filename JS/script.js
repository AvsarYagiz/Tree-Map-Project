...
let drawTreeMap = () => {
    ...
    block.append("rect")
        ...
        .on("mouseover", (movie) => {
            ...
            tooltip.html(
                "Name: " + movie["data"]["name"] + "<br/>" + "Category: " + movie["data"]["category"] + "<br/>" + "Value: $" + movie["data"]["value"]
            );

            // Set attributes on the tooltip element
            document.querySelector("#tooltip").setAttribute("data-name", movie["data"]["name"]);
            document.querySelector("#tooltip").setAttribute("data-category", movie["data"]["category"]);
            document.querySelector("#tooltip").setAttribute("data-value", movie["data"]["value"]);
        })
